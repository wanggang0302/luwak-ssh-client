(function (f) {
    ...
    return (function () {
        ...
        1: [function (require, module, exports) {
            ...
            var AccessibilityManager = (function () {
                function AccessibilityManager(_terminal) {
                    ...
                    this._topBoundaryFocusListener = function (e) {
                        return _this._onBoundaryFocus(e, BoundaryPosition.Top);
                    };
                    this._bottomBoundaryFocusListener = function (e) {
                        return _this._onBoundaryFocus(e, BoundaryPosition.Bottom);
                    };
                    ...
                    this._disposables.push(this._terminal.addDisposableListener('resize', function (data) {
                        return _this._onResize(data.cols, data.rows);
                    }));
                    this._disposables.push(this._terminal.addDisposableListener('refresh', function (data) {
                        return _this._refreshRows(data.start, data.end);
                    }));
                    this._disposables.push(this._terminal.addDisposableListener('scroll', function (data) {
                        return _this._refreshRows();
                    }));
                    this._disposables.push(this._terminal.addDisposableListener('a11y.char', function (char) {
                        return _this._onChar(char);
                    }));
                    this._disposables.push(this._terminal.addDisposableListener('linefeed', function () {
                        return _this._onChar('\n');
                    }));
                    this._disposables.push(this._terminal.addDisposableListener('a11y.tab', function (spaceCount) {
                        return _this._onTab(spaceCount);
                    }));
                    this._disposables.push(this._terminal.addDisposableListener('key', function (keyChar) {
                        return _this._onKey(keyChar);
                    }));
                    this._disposables.push(this._terminal.addDisposableListener('blur', function () {
                        return _this._clearLiveRegion();
                    }));
                    this._disposables.push(this._terminal.addDisposableListener('dprchange', function () {
                        return _this._refreshRowsDimensions();
                    }));
                    this._disposables.push(this._terminal.renderer.addDisposableListener('resize', function () {
                        return _this._refreshRowsDimensions();
                    }));
                    this._disposables.push(Dom_1.addDisposableListener(window, 'resize', function () {
                        return _this._refreshRowsDimensions();
                    }));
                }
        ...
        }, {"./Strings": 15, "./shared/utils/Browser": 33, "./utils/Dom": 36, "./utils/RenderDebouncer": 38}],
        ...
        }, {"./Buffer": 2, "./CharWidth": 4, "./Charsets": 5, "./EscapeSequences": 7, "./renderer/Types": 31}],
        ...
        }, {"./EventEmitter": 8, "./Types": 17, "./input/MouseZoneManager": 21}],
        ...
        12: [function (require, module, exports) {
            ...
            "./EventEmitter": 8,
            "./SelectionModel": 13,
            "./handlers/AltClickHandler": 19,
            "./shared/utils/Browser": 33,
            "./utils/MouseHelper": 37
        }],
        ...
        16: [function (require, module, exports) {
            ...
            var Terminal = (function (_super) {
                ...
                Terminal.prototype.bindKeys = function () {
                    ...
                    if (Browser.isSafari) {
                        on(this.textarea, 'textInput', function (ev) {
                            return _this._textInput(ev);
                        }, true);
                    }
                    else {
                ...
                Terminal.prototype._textInput = function (ev) {
                    var key;
                    if (this.customKeyEventHandler && this.customKeyEventHandler(ev) === false) {
                        return false;
                    }
            ...
            "./Strings": 15,
            "./Viewport": 18,
            "./handlers/Clipboard": 20,
            "./input/MouseZoneManager": 21,
            "./renderer/ColorManager": 24,
            "./renderer/Renderer": 28,
            "./shared/utils/Browser": 33,
            "./utils/CharMeasure": 34,
            "./utils/MouseHelper": 37,
            "./utils/ScreenDprMonitor": 39
        }],
        ...
        28: [function (require, module, exports) {
            ...
            "../EventEmitter": 8,
            "../utils/RenderDebouncer": 38,
            "../utils/ScreenDprMonitor": 39,
            "./ColorManager": 24,
            "./CursorRenderLayer": 25,
            "./LinkRenderLayer": 27,
            "./SelectionRenderLayer": 29,
            "./TextRenderLayer": 30
        }],
        ...
        }, {"../Buffer": 2, "./BaseRenderLayer": 22, "./GridCache": 26, "./Types": 31}],
